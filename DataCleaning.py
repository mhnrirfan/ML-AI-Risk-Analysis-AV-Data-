...
adas_data = pd.read_csv('/Users/mahnooriqbal/COMP702 Project/ML-AI-Risk-Analysis-AV-Data-/US/SGO-2021-01_Incident_Reports_ADAS.csv')
ads_data = pd.read_csv('/Users/mahnooriqbal/COMP702 Project/ML-AI-Risk-Analysis-AV-Data-/US/SGO-2021-01_Incident_Reports_ADS.csv')
...
def US_Data_Cleaning(adas, ads):
    ...
    merged_df.to_csv('/Users/mahnooriqbal/COMP702 Project/ML-AI-Risk-Analysis-AV-Data-/US/cleaned_data.csv', index=False)

    return merged_df.shape

# Run the cleaning function on your data
shape_after_cleaning = US_Data_Cleaning(adas_data, ads_data)
print(f"Shape of cleaned dataset: {shape_after_cleaning}")
